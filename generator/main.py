...
def main():
    ...
    managers = [ModelManager(inputs=10, outputs=1, layers=3, layer_size=20) for _ in range(100)]
    ...
    for i in range(501):
        ...
        clones = [manager.clone(weight_divergence=0.5) for _ in range(5) for manager in managers]
